...
Then, you'll need to create a cluster on a hosting provider. Refer to the provider-specific instructions to build the basic infrastructure and upload the appropriate github secrets:
